...
class Ability extends Enumeration
{
	...
	const BLACK_MAGIC_USES_×2 = [
		'slug' => 'black_magic_uses_×2',
		'name' => "Black Magic Uses ×2",
	...
	const DARK_MAGIC_USES_×2 = [
		'slug' => 'dark_magic_uses_×2',
		'name' => "Dark Magic Uses ×2",
	...
	const WHITE_MAGIC_USES_×2 = [
		'slug' => 'white_magic_uses_×2',
		'name' => "White Magic Uses ×2",
	...
	const POMP_&_CIRCUMSTANCE = [
		'slug' => 'pomp_&_circumstance',
	...
	const LETHALITY = [
		'slug' => 'lethality',
		'name' => "Lethality",
		'description' => "Chance to instantly kill a foe when dealing damage. Trigger % = 0.25×Dex.",
